...
export const translations = {
  de: {
    ...
    lblVoucherNoAuto: 'Automatisch',
    placeholderVoucherNo: 'z.B. 1, 2, RE-2026-001',
    ...
    btnAdd: 'Hinzufügen',
    lblContraAccountColH: 'Spalte H',
    placeholderContraAccountColH: '',
    helpContraAccountColH: 'DATEV Spalte H. Wird automatisch aus der Buchungsregel übernommen oder manuell angepasst.',
    ...
    advisorNumHelp: 'Gültiger DATEV-Bereich: 1001 – 9999999 (4 bis 7 Ziffern)',
    advisorNumInvalid: 'Ungültig: Die Beraternummer muss zwischen 1001 und 9999999 liegen.',
    clientNumHelp: 'Gültiger DATEV-Bereich: 1 – 99999 (1 bis 5 Ziffern)',
    clientNumInvalid: 'Ungültig: Die Mandantennummer muss zwischen 1 und 99999 liegen.',
    ...
    lblContraAccount: 'Gegenkonto',
    lblContraAccountSkr03: 'Gegenkonto SKR03',
    lblContraAccountSkr04: 'Gegenkonto SKR04',
    ...
    monthClosedBadge: 'Monat {month}/{year} abgeschlossen (Schreibgeschützt)',
    descMonthClosed: 'Vergangene Monate sind nach gesetzlichen Vorschriften abgeschlossen und schreibgeschützt. Buchungen können nur noch eingesehen und exportiert werden.',
    ...
    thPermissions: 'Berechtigungen',
    lblPermissions: 'Benutzerdefinierte Berechtigungen',
    lblPermissionsDesc: 'Berechtigungen für diesen Benutzer individuell konfigurieren oder Standardwerte verwenden.',
    permAddIncome: 'Einnahmen erfassen (+)',
    permAddIncomeDesc: 'Neue Bareinnahmen im Kassenbuch eintragen',
    permAddExpense: 'Ausgaben erfassen (-)',
    permAddExpenseDesc: 'Neue Barausgaben im Kassenbuch eintragen',
    permEditEntry: 'Einträge bearbeiten (✎)',
    permEditEntryDesc: 'Bestehende Buchungen im Kassenbuch ändern',
    permDeleteEntry: 'Einträge löschen (🗑)',
    permDeleteEntryDesc: 'Buchungen im Kassenbuch stornieren / löschen',
    permExportReports: 'Exporte & Berichte (⤓)',
    permExportReportsDesc: 'PDF-, Excel-, XML- und DATEV-Exporte herunterladen',
    permManageSettings: 'Einstellungen & Anfangsbestand (⚙)',
    permManageSettingsDesc: 'Kassen-Anfangsbestand, DATEV und Buchungsregeln bearbeiten',
    btnSelectAll: 'Alle aktivieren',
    btnDeselectAll: 'Alle deaktivieren',
    btnResetDefaults: 'Auf Standard zurücksetzen',
    badgeFullAccess: 'Vollzugriff',
    badgeReadOnly: 'Nur Ansicht',
    badgeCustomPerms: 'Individuell',
    permShortIncome: '+ Einnahmen',
    permShortExpense: '- Ausgaben',
    permShortEdit: '✎ Bearbeiten',
    permShortDelete: '🗑 Löschen',
    permShortExport: '⤓ Export',
    permShortSettings: '⚙ Einstellungen',
    ...
    // Cookie & Privacy
    cookieBannerTitle: 'Cookie- & Speicherhinweis',
    cookieBannerDesc: 'Diese Anwendung speichert notwendige Daten in Ihrem Browser (Sitzungs-Token und Spracheinstellungen), um Ihre Anmeldung und Einstellungen aufrechtzuerhalten.',
    cookieBtnAcceptAll: 'Verstanden & Akzeptieren',
    cookieBtnEssentialOnly: 'Schließen',
    cookieBtnCustomize: 'Details',
  ...
  en: {
    ...
    lblVoucherNoAuto: 'Auto',
    placeholderVoucherNo: 'e.g. 1, 2, INV-2026-001',
    ...
    btnAdd: 'Add',
    lblContraAccountColH: 'Column H',
    placeholderContraAccountColH: '',
    helpContraAccountColH: 'DATEV Column H. Auto-filled from booking rule or custom adjusted.',
    ...
    advisorNumHelp: 'Valid DATEV range: 1001 – 9999999 (4 to 7 digits)',
    advisorNumInvalid: 'Invalid: Advisor number must be between 1001 and 9999999.',
    clientNumHelp: 'Valid DATEV range: 1 – 99999 (1 to 5 digits)',
    clientNumInvalid: 'Invalid: Client number must be between 1 and 99999.',
    ...
    lblContraAccount: 'Contra Account',
    lblContraAccountSkr03: 'Contra Account SKR03',
    lblContraAccountSkr04: 'Contra Account SKR04',
    ...
    monthClosedBadge: 'Month {month}/{year} Closed (Read-Only)',
    descMonthClosed: 'Past months are closed and locked in compliance with accounting rules. Entries cannot be added, edited, or deleted.',
    ...
    lblPermissions: 'Customizable Permissions',
    lblPermissionsDesc: 'Configure granular permissions for this user or use role defaults.',
    permAddIncome: 'Add Income (+)',
    permAddIncomeDesc: 'Record new cash income entries',
    permAddExpense: 'Add Expense (-)',
    permAddExpenseDesc: 'Record new cash expense entries',
    permEditEntry: 'Edit Entries (✎)',
    permEditEntryDesc: 'Modify existing entries in the cash book',
    permDeleteEntry: 'Delete Entries (🗑)',
    permDeleteEntryDesc: 'Delete or void cash book entries',
    permExportReports: 'Export & Reports (⤓)',
    permExportReportsDesc: 'Download PDF, Excel, XML, and DATEV exports',
    permManageSettings: 'Settings & Opening Balance (⚙)',
    permManageSettingsDesc: 'Configure cash opening balance, DATEV, and booking rules',
    btnSelectAll: 'Select All',
    btnDeselectAll: 'Deselect All',
    btnResetDefaults: 'Reset to Defaults',
    badgeFullAccess: 'Full Access',
    badgeReadOnly: 'Read Only',
    badgeCustomPerms: 'Custom',
    permShortIncome: '+ Income',
    permShortExpense: '- Expenses',
    permShortEdit: '✎ Edit',
    permShortDelete: '🗑 Delete',
    permShortExport: '⤓ Export',
    permShortSettings: '⚙ Settings',
    ...
    // Cookie & Privacy
    cookieBannerTitle: 'Cookie & Storage Notice',
    cookieBannerDesc: 'This application stores essential data in your browser (session token and language preference) to keep you logged in and preserve your settings.',
    cookieBtnAcceptAll: 'Got It & Accept',
    cookieBtnEssentialOnly: 'Dismiss',
    cookieBtnCustomize: 'Details',
